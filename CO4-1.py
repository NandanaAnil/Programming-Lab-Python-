...
obj=rectangle(a,b)
obj1=rectangle(c,d)
print("Area of 1 rectangle:",obj.area(),"and","perimeter of rectanglr:",obj.perimeter())
print("Area of 2 rectangle:",obj1.area(),"and","perimeter of rectanglr:",obj1.perimeter())
